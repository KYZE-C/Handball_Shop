...
namespace Handball_Shopv1.Server.Migrations
{
    ...
    [Migration("20230816102016_Fixed")]
    partial class Fixed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Handball_Shopv1.Shared.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 4,
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7274),
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7329),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7333),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 4,
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7336),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7339),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 1,
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7343),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 7,
                            CategoryId = 3,
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7346),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CategoryId = 4,
                            Color = "Black",
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7349),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 9,
                            CategoryId = 3,
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7352),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            Color = "Yellow",
                            DateCreated = new DateTime(2023, 8, 16, 11, 20, 16, 136, DateTimeKind.Local).AddTicks(7355),
                            DateUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
